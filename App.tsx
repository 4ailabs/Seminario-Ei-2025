...
const BackToTop: React.FC = () => {
    ...
    return (
        <button
            onClick={scrollToTop}
            className={`fixed bottom-20 right-4 sm:bottom-24 sm:right-8 z-50 p-3 sm:p-3 bg-cyan-500 hover:bg-cyan-600 text-white rounded-full shadow-lg transition-all duration-300 transform ${
